...
$mysqli = new mysqli('localhost', 'root', '', 'slot2_it');

// Define an array of faculty names and corresponding venues (you can add more faculty names and venues)
$faculties = 
[
    "Mrs.AMUTHA" => "10202",
    "DR. N.SUBBULAKSHMI" => "10201",
    "MR. R.RAJA SEKAR" => "7312",
    "Mrs. N.KRITHIGA" => "7311",
    "Ms. V.RAGAVARTHINI" => "7310",
    "DR. KARTHIKEYAN" => "7309",
];
...
if (isset($_POST['submit'])) {
    ...
    if (hasStudentBookedFaculty($mysqli, $registerNumber, $CourseName)) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: SLOT2-IT-INFRA.php"); // Change "success.php" to your desired success page
