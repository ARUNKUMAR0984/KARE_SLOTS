...
$mysqli = new mysqli('localhost', 'root', '', 'slot1_dm');
...
$faculties = [
    "DR. B.REDDAPPA" => "10305",
    "DR. K.KARUPPASAMY" => "10306",
    "DR. L.SREENIVASULU REDDY" => "10303",
    "DR. K.AMARNADHA REDDY" => "10302",
    "Ms. BLESSINA ESTHER" => "10301",
    "Ms. N.MURUGESWARI" => "10203",
];
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> CHOOSE YOUR DISCRETE MATHEMATICS FACULTY</strong></marquee>
    </div>
    <br><br>
    ...
    <table class="booked-slots">
        ...
        ?>
            <tr>
                ...
                <td><strong>212 CSE 2101</strong></td>
                ...
                <td>
                    <button type="button" class="btn btn-primary book" data-toggle="modal" data-target="#myModal"
                        ...
                        data-course-name="DISCRETE MATHEMATICS"
                        data-course-code="212 CSE 2101"
