...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        ...
        $adminMail->Password = ''; // Replace with your SMTP password
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> BOOK YOUR SLOTS AT
                LIBRARY SEMINAR HALL</strong></marquee>
    </div>
    <center>
        <h2><STRONG>LIBRARY SEMINAR HALL</STRONG></h2>
    </center>
    <div class="container">
