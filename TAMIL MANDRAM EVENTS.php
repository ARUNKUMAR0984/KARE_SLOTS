...
<div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> CHOOSE YOUR தமிழ் மன்றம் EVENTS</strong></marquee>
    </div><br><br>
    ...
    <table class="booked-slots">
            ...
            <tr>
                    ...
                    <td><a class="btn btn-primary" href="tamilmandramavail.php
                    " id="button">BOOK</a></td>
