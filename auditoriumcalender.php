        ...
        if ($dayname == 'saturday' || $dayname == 'sunday') {
            ...
            if ($date <= date('Y-m-d')) {
                ...
                if ($totalbookings >= 9) {
                    ...
                    $calender .= "<td class='$today'><h4>$currentDay</h4><a href='auditoriumbooking.php?date=" . $date . "' class='btn btn-success btn-xs'>View Slots</a><small><strong>  $availableslots slots Remaining</strong></small>";
                }
            }
        }
...
<div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> BOOK YOUR SLOTS AT AUDITORIUM</strong></marquee>
    </div>
    <br><br>
    <div class="container">
    <a class="btn btn-primary" href="index.php" id="button">Home</a>
    <center><h3><strong>AUDITORIUM</strong></h3></center>
        <div class="row">
            <div class="col-md-12">
            <?php
