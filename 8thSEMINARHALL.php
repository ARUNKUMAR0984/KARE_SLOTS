    ...
    while($currentDay<=$numberDays)
    {
        ...
        if ($dayname == 'saturday' || $dayname == 'sunday') {
            ...
            if ($date <= date('Y-m-d')) {
                ...
                if ($totalbookings >= 9) {
                    $calender .= "<td class='$today'><h4>$currentDay</h4><a href='#' class='btn btn-danger btn-xs'>All Slots Booked</a>";
                } else {
                    $availableslots = 9 - $totalbookings;
                    $calender .= "<td class='$today'><h4>$currentDay</h4><a href='8thSEMINARHALLBOOKING.php?date=" . $date . "' class='btn btn-success btn-xs'>View Slots</a><small><strong>  $availableslots slots Remaining</strong></small>";
                }
            }
        }
...
<div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> BOOK YOUR SLOTS AT 8TH BLOCK SEMINAR HALL</strong></marquee>
    </div>
    <br><br>
    ...
    <center><h2><strong> 8TH BLOCK SEMINAR HALL</strong></h2></center>
        <div class="row">
            <div class="col-md-12">
            <?php
