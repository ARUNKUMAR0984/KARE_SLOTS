...
$calender .= "<tr>";
    ...
    while($currentDay<=$numberDays)
    {
        ...
        if ($dayname == 'saturday' || $dayname == 'sunday') {
            ...
            if($totalbookings==9)
            {
                $calender .= "<td class='$today'><h4>$currentDay</h4><a href='libraryseminarhallbooking.php?date=" . $date . "' class='btn btn-danger btn-xs'>All Slots Booked</a>";
            }
            else{$availableslots = 9-$totalbookings;
                $calender .= "<td class='$today'><h4>$currentDay</h4><a href='libraryseminarhallbooking.php?date=" . $date . "' class='btn btn-success btn-xs'>View Slots</a><small><strong>  $availableslots slots Remaining</strong></small>";
            }
...
<div class="marquee-container">
    ...
    <center><h3><strong>LIBRARY SEMINAR HALL</strong></h3></center>
        <div class="row">
            <div class="col-md-12">
            <?php
