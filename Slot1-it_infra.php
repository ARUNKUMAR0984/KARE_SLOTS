...
$mysqli = new mysqli('localhost', 'root', '', 'slot1_it');

// Define an array of faculty names and corresponding venues (you can add more faculty names and venues)
$faculties = [
    "DR. KOTESWARA RAO ANNE" => "10305",
    "MR.GOKULA KRISHNAN" => "10306",
    "MR.V.SATHYA NARAYANAN" => "10303",
    "DR. P.PANDI SELVAM" => "10302",
    "MR. SAKTHI KARTHI DURAI" => "10301",
    "Mrs.K.DEEPALAKSHMI" => "10203",
...
if (isset($_POST['submit'])) {
    ...
    if (hasStudentBookedFaculty($mysqli, $registerNumber, $CourseName)) {
        ...
        if ($stmt->execute()) {
            ...
            // Redirect to a different page or the same page to prevent form resubmission
            header("Location: Slot1-it_infra.php"); // Change "success.php" to your desired success page
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> CHOOSE YOUR IT INFRASTRUCTUARE AND LANDSCAPE OVERVIEWFACULTY</strong></marquee>
    </div>
    <br><br>
    ...
    <table class="booked-slots">
        ...
        ?>
            <tr>
                ...
                <td><strong>IT INFRASTRUCTUARE AND LANDSCAPE OVERVIEW</strong></td>
                <td><strong>212 CSE 1101</strong></td>
                ...
                <td>
                    <button type="button" class="btn btn-primary book" data-toggle="modal" data-target="#myModal"
                        ...
                        data-course-name="IT INFRASTRUCTUARE AND LANDSCAPE OVERVIEW"
                        data-course-code="212 CSE 1101"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post"> <!-- Add the form element with the 'post' method -->
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" readonly name="slot" id="slot" class="form-control" value="Slot 1">
                    </div>
                    <div class="form-group">
                    ...
                    <button class="btn btn-primary" type="submit" name="submit" id="bookButton">Book</button> <!-- Add the 'Submit' button -->
                </div>
            </form>
        </div>
    </div>
    ...
    $(document).ready(function () {
        $(".book").click(function () {
            ...
            $("#facultyNameDisplay").val(facultyName); // Use .val() to set input values
...
<script>
    $("#bookButton").click(function () {
    // Check if the student has already booked a faculty for the same course
    if (hasStudentBookedFaculty($mysqli, $registerNumber, $CourseName)) {
        // Display the error alert
        $("#errorAlert").html("You have already booked a faculty for this course.");
        $("#errorAlert").show(); // Show the error alert
    } else {
        // If not already booked, you can submit the form as before
        // Handle the booking logic here, e.g., sending a request to the server
    }
});
