...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        ...
        $userMail->Body = "Hello <strong>$name</strong>,<br>Your booking for timeslot $timeslots on date $dates at 9TH BLOCK SEMINAR HALL to conduct <strong>$purpose</strong> with <strong>$requirements</strong> has been submitted for approval.<br>Please stay tuned.<br> Thank you for choosing our service!";
        ...
        $dates = date('d-m-Y', strtotime($date));
        $adminMail->Body = "Hello Sir,<br>There is a booking application for timeslot $timeslots on date $dates at 9TH BLOCK SEMINAR HALL to conduct <strong>$purpose</strong> with <strong>$requirement</strong> that has been submitted for approval.<br><br> Click below to approve the booking:<br>";
        ...
        try {
            ...
            // SMS Gateway Code
$fields = array(
    "message" => "New booking by $name for timeslot $timeslots on date $dates at 9TH COMPLEX SEMINAR HALL-(8004). Please review and approve.",
    "language" => "english",
    "route" => "q",
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> BOOK YOUR SLOTS AT 9TH
                BLOCK SEMINAR HALL</strong></marquee>
    </div>
    <center>
        <h2><STRONG>9TH BLOCK SEMINAR HALL</STRONG></h2>
    </center>
    <div class="container">
