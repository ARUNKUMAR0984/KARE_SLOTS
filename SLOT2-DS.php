...
$mysqli = new mysqli('localhost', 'root', '', 'slot2_dS');
...
$faculties = [
    "DR. M.JAYALAKSHMI" => "10202",
    "DR. P.VELUMURUGADASS" => "10201",
    "Mrs. P.KALAIARASI" => "7312",
    "MR. V.MARUTHUPANDI" => "7311",
    "Mrs. KARDEEPA" => "7310",
    "Ms. V.RAGAVARTHINI" => "7309",
];
