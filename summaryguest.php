...
$eventLocation = 'KARE GUEST HOUSE';
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul>
                            ...
                            <li><strong>Venue:</strong> GUEST HOUSE</li>
                        </ul>
                        <center><a class="btn btn-primary" href="index.php" id="button">Home</a><br><br></center>
                    <center><a class="btn btn-primary" href="GUEST HOUSE.php" id="button">Back to calendar</a><br><br></center>
