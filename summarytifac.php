...
$eventLocation = 'TIFAC CORE SEMINAR HALL';
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul>
                            ...
                            <li><strong>Venue:</strong> TIFAC CORE SEMINAR HALL </li>
                        </ul>
                        <center><a class="btn btn-primary" href="index.php" id="button">Home</a><br><br></center>
                    <center><a class="btn btn-primary" href="TCseminarhall.php" id="button">Back to calendar</a><br><br></center>
