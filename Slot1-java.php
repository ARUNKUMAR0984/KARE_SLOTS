...
$mysqli = new mysqli('localhost', 'root', '', 'slot1_java');

// Define an array of faculty names and corresponding venues (you can add more faculty names and venues)
$faculties = [
    "DR. T.DHILIPHAN RAJKUMAR" => "10305",
    "DR. T.SAM PRADEEPRAJ" => "10306",
    "DR. MR.S.SURESH KUMAR" => "10303",
    "DR. MS.S.ISHVARYA" => "10302",
    "DR. AKBAR BADHUSHA MOHIDEEN" => "10301",
    "DR. G.NAGARAJAN" => "10203",
...
if (isset($_POST['submit'])) {
    ...
    if (hasStudentBookedFaculty($mysqli, $registerNumber, $CourseName)) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: Slot1-java.php"); // Change "success.php" to your desired success page
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> CHOOSE YOUR JAVA PROGRAMMING FACULTY</strong></marquee>
    </div>
    <br><br>
    ...
    <table class="booked-slots">
        ...
        ?>
            <tr>
                ...
                <td><strong>212 CSE 2403</strong></td>
                ...
                <td>
                    <button type="button" class="btn btn-primary book" data-toggle="modal" data-target="#myModal"
                        ...
                        data-course-name="JAVA PROGRAMMING"
                        data-course-code="212 CSE 2403"
