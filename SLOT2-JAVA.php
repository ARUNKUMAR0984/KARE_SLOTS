...
$mysqli = new mysqli('localhost', 'root', '', 'slot2_java');

// Define an array of faculty names and corresponding venues (you can add more faculty names and venues)
$faculties = [
    "DR. T. DHILIPHAN RAJKUMAR" => "10202",
    "MR. S.SURESHKUMAR" => "10201",
    "MR. K.VIGNESH" => "7312",
    "Ms. M.ISHVARYA" => "7311",
    "DR. M.ISLABUDEN" => "7310",
    "MR. AKBAR BADHUSHA MOHIDEEN" => "7309",
];
...
if (isset($_POST['submit'])) {
    ...
    if (hasStudentBookedFaculty($mysqli, $registerNumber, $CourseName)) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: SLOT2-JAVA.php"); // Change "success.php" to your desired success page
