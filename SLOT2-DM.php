...
$mysqli = new mysqli('localhost', 'root', '', 'slot2_dm');
...
$faculties = [
    "DR. V.YEGANANARAYANAN" => "10202",
    "DR. P.VIMALA DEVI" => "10201",
    "MR. M.SANKARANNARAYANAN" => "7312",
    "Mrs. M.ANITHA" => "7311",
    "MR. K.THANGAMUNIAPPAN" => "7310",
    "MR. I.MUTHUSELVAM" => "7309",
];
