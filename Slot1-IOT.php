...
$mysqli = new mysqli('localhost', 'root', '', 'slot1_iots');
...
$faculties = [
    "DR. RAJAKRISHNA MOORTHI" => "10305",
    "DR. S.DIWAKARAN" => "10306",
    "DR. J.CHARLES PRAVIN" => "10303",
    "DR. V.MUNEESWARAN" => "10302",
    "DR. R.SUMATHY" => "10301",
    "DR. HIMA DEEPTHI" => "10203",
];
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> CHOOSE YOUR IOTS FACULTY</strong></marquee>
    </div>
    <br><br>
    ...
    <table class="booked-slots">
        ...
        ?>
            <tr>
                ...
                <td><strong>IOT SENSORS AND DEVICES</strong></td>
                <td><strong>211 ECE 1400</strong></td>
                ...
                <td>
                    <button type="button" class="btn btn-primary book" data-toggle="modal" data-target="#myModal"
                        ...
                        data-course-name="IOT SENSORS AND DEVICES"
                        data-course-code="212 ECE 1400"
