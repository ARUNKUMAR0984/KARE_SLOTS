...
if (isset($_REQUEST['pwdrst'])) {
    ...
    if ($pwd == $cpwd) {
        ...
        $update_query = "UPDATE users SET password='$hashed_pwd' WHERE email='$email'";
        $reset_pwd = mysqli_query($con, $update_query);

        if ($reset_pwd) {
            $msg = 'Your password updated successfully <a href="index.php">Click here</a> to login';
        } else {
            $msg = "Error while updating password: " . mysqli_error($con);
        }
    } else {
                        ...
                        <form id="validate_form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="cpwd" id="cpwd" placeholder="Enter Confirm Password"
                                    required data-parsley-type="cpwd" data-parsley-trigger="keyup"
                                    class="form-control" />
                            </div>
                            <div class="form-group">
