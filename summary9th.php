...
$eventSummary = 'Booking for 9th block Seminar Hall';
$eventDescription = 'Details about the booking';
$eventLocation = '9th Block Seminar Hall';
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul>
                            ...
                            <li><strong>Venue:</strong> 9TH BLOCK SEMINAR HALL</li>
                        </ul>
                        <center><a class="btn btn-primary" href="index.php" id="button">Home</a><br><br></center>
                    <center><a class="btn btn-primary" href="9thseminarhall.php" id="button">Back to calendar</a><br><br></center>
