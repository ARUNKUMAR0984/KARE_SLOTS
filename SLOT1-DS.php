...
$mysqli = new mysqli('localhost', 'root', '', 'slot1_dS');
...
$faculties = [
    "Mrs. P.KALAIARASI" => "10305",
    "DR. V.ANUSUYA DEVI" => "10306",
    "MR. V.ARAVINDARAJAN" => "10303",
    "MR. B.SHANMUGA RAJA" => "10302",
    "Mr. KALAICHELVAN" => "10301",
    "Mrs. KARDEEPA" => "10203",
];
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> CHOOSE YOUR DATA STRUCTURES FACULTY</strong></marquee>
    </div>
    <br><br>
    ...
    <table class="booked-slots">
        ...
        ?>
            <tr>
                ...
                <td><strong>212 CSE 2301</strong></td>
                ...
                <td>
                    <button type="button" class="btn btn-primary book" data-toggle="modal" data-target="#myModal"
                        ...
                        data-course-name="DATA STRUCTURES"
                        data-course-code="212 CSE 2301"
