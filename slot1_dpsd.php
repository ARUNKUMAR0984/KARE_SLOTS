...
$mysqli = new mysqli('localhost', 'root', '', 'slot1_dpsd');
...
$faculties = [
    "DR. P.MUTHUVEL" => "10305",
    "DR. ABHISHEK TRIPATHI" => "10306",
    "Mrs. LAVANYA" => "10303",
    "DR. A.PARIVAZHAGAN" => "10302",
    "DR. V.SATHYA NARAYANAN" => "10301",
    "DR. B.PRADEEPRAJA" => "10203",
];
...
if (isset($_POST['submit'])) {
    ...
    if (hasStudentBookedFaculty($mysqli, $registerNumber, $CourseName)) {
        ...
        $stmt = $mysqli->prepare("INSERT INTO users (Student_Name, Facultyname, coursename, course_code, email, venue, phonenumber, Register_number) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param('ssssssss', $name, $Facultyname, $CourseName, $CourseCode, $email, $venue, $phonenumber, $registerNumber);
        ...
        if ($stmt->execute()) {
            ...
            header("Location: Slot1_dpsd.php");
            exit;
        } else {
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> CHOOSE YOUR DPSD FACULTY</strong></marquee>
    </div>
    <br><br>
    ...
    <table class="booked-slots">
        ...
        ?>
            <tr>
                ...
                <td><strong>DIGITAL PRINCIPLE AND SYSTEM DESIGN</strong></td>
                <td><strong>212 CSE 2302</strong></td>
                ...
                <td>
                    <button type="button" class="btn btn-primary book" data-toggle="modal" data-target="#myModal"
                        ...
                        data-course-name="DIGITAL PRINCIPLE AND SYSTEM DESIGN"
                        data-course-code="212 CSE 2302"
