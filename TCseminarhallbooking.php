...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> BOOK YOUR SLOTS AT TIFAC
                CORE SEMINAR HALL</strong></marquee>
    </div>
    <center>
        <h2><STRONG>TIFAC CORE SEMINAR HALL</STRONG></h2>
    </center>
    <div class="container">
