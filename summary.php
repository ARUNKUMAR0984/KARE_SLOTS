...
$eventLocation = '8th Block Seminar Hall';
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="alert alert-success">
                            <strong>Booking Submitted!,Email Sent Successfully</strong>
                        </div>
                        ...
                        <ul>
                            ...
                            <li><strong>Venue:</strong> 8TH BLOCK SEMINAR HALL</li>
                            <li><strong>Status:</strong> Submitted for approval</li>

                        </ul>
                        <center><a class="btn btn-primary" href="index.php" id="button">Home</a><br><br></center>
                    <center><a class="btn btn-primary" href="8thSEMINARHALL.php" id="button">Back to calendar</a><br><br></center>
