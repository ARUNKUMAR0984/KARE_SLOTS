...
section ul li.active
{
    ...
    <style>
        ...
        /* CSS for hiding the dropdown content */
.user-dropdown .dropdown-content {
   ...
   <style>
        /* Style for the user dropdown container */
        .user-dropdown {
            position: relative;
        ...
        .dropdown-content {
            ...
            padding: 10px;
            border-radius: 5px;
            /* Position it to the right of the user icon */
            top: 60px; /* Adjust the distance from the user icon */
        }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link me-2" href="mycourse.php">MY COURSES</a>
        </li>
        <div class="user-dropdown">
        <img class="user-icon" src="user.jpeg" id="user-icon" alt="User Image">
    <div class="dropdown-content" id="user-details">
        <h2>User Details</h2>
        <p><strong>Name:</strong> <?php echo $user_data['user_name']; ?></p>
        <p><strong>Email:</strong> <?php echo $user_data['email']; ?></p>
        <p><strong>Phone Number:</strong> <?php echo $user_data['phonenumber']; ?></p>
    </div>
</div>
      </ul>
      <div class="d-flex">
...
<div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide"><a href="seminarhallvenues.php">
                        <img src="seminar-hall-2.jpg" alt="" width="425px" height="160px" class="w-100 d-block" style="height: 300px;">
                    </a>
                    <br>
      ...
      <div class="swiper-slide"><a href="auditoriumcalender.php">
                    ...
                    <div class="swiper-slide"><a href="GUEST HOUSE.php">
                        <img src="GUEST HOUSE.jpeg" alt="" width="425px" height="160px" class="w-100 d-block" style="height: 300px;">
                    </a>
                    <br>
                    <center><h3 class="me-5 fw-bold fs-3 h-font">GUEST HOUSE</h3></center></div>
...
<div class="container">
<div class="container-fluid">
<h1 class="heading me-5 fw-bold fs-3 h-font"> </center> CLASSES & LECTURES </center></h1><br><br>
<div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide" ><a href="CLASSES SLOTS.PHP">
                        <img src="CLASS ROOM.jpeg" alt="" width="425px" height="160px" class="w-100 d-block" style="height: 300px;">
                    </a><center><br>
                        <h3 class="me-5 fw-bold fs-3 h-font">CLASSES</h3></center> 
