...
$mysqli = new mysqli('localhost', 'root', '', 'slot1_pa');
...
$faculties = [
    "MR. R.MARISELVAN" => "10305",
    "Ms. V.S.VETRISELVI" => "10306",
    "MR. C.SIVAMURUGAN" => "10303",
    "Mrs. LOYOLA JASMINE" => "10302",
    "MR. P.SURESH KUMAR" => "10301",
    "DR. T.MANIKUMAR" => "10203",
];
...
<body>
    <div class="marquee-container">
        <marquee class="marquee-content"><strong>HELLO, <?php echo $user_data['user_name']; ?> CHOOSE YOUR PREDICTIVE
                ANALYSIS FACULTY</strong></marquee>
    </div>
    <br><br>

    <CENTER><a class="btn btn-primary" href="index.php" id="button">Home</a></CENTER>
    <center>
        <h3><strong>AVAILABLE FACULTIES</strong></h3>
    </center><br><br>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-primary book" data-toggle="modal" data-target="#myModal"
                            data-faculty-name="<?php echo $facultyName; ?>" data-course-name="PREDICTIVE ANALYSIS"
                            data-course-code="213 CSE 2301" data-venue="<?php echo $venue; ?>">BOOK
                        </button>
                    </td>
                </tr>
                <?php
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" readonly name="registernumber" id="registernumber"
                                class="form-control" value="<?php echo $user_data['register_number']; ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" readonly name="slot" id="slot" class="form-control"
                                value="Slot 1">
                        </div>
                        <div class="form-group">
                            <label for="facultyName">Faculty Name:</label>
                            <input required type="text" readonly name="faculty_name" class="form-control"
                                id="facultyNameDisplay">
                        </div>
                        <div class="form-group">
                            <label for="courseName">Course Name:</label>
                            <input required type="text" readonly name="course_name" class="form-control"
                                id="courseNameDisplay">
                        </div>
                        <div class "form-group">
                            <label for="courseCode">Course Code:</label>
                            <input required type="text" readonly name="course_code" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="phonenumber" id="phonenumber" placeholder="Enter your phone number"
                                ...
                                value="<?php echo $user_data['phonenumber']; ?>" required>
                        </div>
                        <div class="form-group">
